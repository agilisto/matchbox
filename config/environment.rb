...
Rails::Initializer.run do |config|
  ...
  config.load_paths += %W(  #{RAILS_ROOT}/vendor/plugins/simple-rss-1.1/lib
                            ...
                            #{RAILS_ROOT}/vendor/plugins/chronic-0.2.3/lib )
  ...
  config.action_controller.session = {
    :session_key => '_matchbox_session',
    :secret      => '0b439becd0fe4db534aeb078fa7845eab145c39d41fb47e100a2a450c88f8597e9a35cb07c87644986735ecfa118ecdb8a8a3db58b5c96cd58e3210e5baa1992'
  }
